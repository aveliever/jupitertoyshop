...
public final class FileDownloader {
	...
	/**
	 * Checks if a file is present in the specified directory within a given timeout.
	 *
	 * @param fileName the name of the file to check.
	 * @param timeout the maximum time to wait in seconds.
	 * @return true if the file exists within the timeout, false otherwise.
	 * @throws InterruptedException if the thread is interrupted while waiting.
	 */
	public static boolean WaitForFileDownload(String fileName, int timeout) throws InterruptedException {
		Path filePath = Paths.get(DOWNLOADS_DIRECTORY, fileName);

		// Poll the directory until the file appears or the timeout is reached
		int waitTime = 0;
